...
from torch_itl.estimator import FuncOREigen, SparseFuncOREigen
...
epsilon = 0.1
esti_eps2 = SparseFuncOREigen(mod, lbda, loss_param=epsilon)
esti_eps2.fit(Xtrain, Ytrain, thetas.view(-1, 1))
pred_eps2 = esti_eps2.predict(Xtest, thetas.view(-1, 1))
# Print test score
print(((pred_eps2 - Ytest) ** 2).mean())
# Print sparsity level
print(esti_eps2.get_sparsity_level())
